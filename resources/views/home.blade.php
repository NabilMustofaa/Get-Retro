...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center" data-aos="fade-up" style="width:100vw">
      <h1>Welcome to <span>Get.retro</span></h1>
      <h2>Best Price, High Quality, Just For You</h2>
      <a href="#portfolio" class="btn-get-started scrollto">Our Product</a>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="what-we-do" class="what-we-do">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Thrift Was A Trend</h2>
          <p class="col-md-6 mx-auto">Shopping secondhand reduces the cost of fashion by giving new life to used clothes. Resale moves us one step closer to a circular fashion future.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              <div class="icon"></i>
                <i class="bi bi-brightness-high-fill"></i></i></div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              <div class="icon"><i class="bi bi-tag-fill"></i></i></div>
