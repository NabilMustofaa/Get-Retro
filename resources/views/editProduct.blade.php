                    ...
                    <div style="width: 60vw">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              ...
                              is-invalid
                               @enderror" id="productName" name="productName" placeholder="Nama Product..." value="{{ old('productName',$product->productName) }}">
                            </div>
                            @error('productName')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                is-invalid
                                 @enderror " id="productDescription" name="productDescription" rows="3" >{{ old('productDescription',$product->productDescription) }}</textarea>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              ...
                              is-invalid
                               @enderror" id="productPrice" name="productPrice"placeholder="Harga Product..." value="{{ old('productPrice',$product->productPrice) }}">
                            </div>
                            @error('productPrice')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              ...
                              is-invalid
                               @enderror" id="productLeft" name="productLeft"placeholder="Jumlah Product..." value="{{ old('productLeft',$product->productLeft) }}">
                            </div>
                            @error('productLeft')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4" >
                                <select id="categoryId" name="categoryId" class="form-control">
                                    ...
                                    @if (old('categoryId',$product->productDescription)==$item->id)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4" >
                                    <select id="brandId" name="brandId" class="form-control">
                                        ...
                                        @if (old('brandId',$product->BrandID)==$item->id)
